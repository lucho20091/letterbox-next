          ...
          <div className="mt-4 md:mt-8">
            {usersWatchlist &&
              usersWatchlist.map((user) => (
                <div
                  key={user}
                  className="mb-4 md:mb-8 flex flex-col gap-4 sm:gap-6"
                >
                  <Link
                  ...
                  >
                    <img
                      src={watchlist[user][0].userImage}
                      alt={watchlist[user][0].username}
                      className="w-10 h-10 rounded-full border-2 border-purple-400"
                    />
                    <p className="font-bold underline underline-offset-8 decoration-purple-400">
                      {user}
                    </p>
                  </Link>
